...
[role="lead"]
ウォッチリストを作成すると、一連のストレージ システムにすばやく簡単にアクセスできます。カテゴリまたはシリアル番号に基づいてストレージ システムを追加できます。


NOTE: カテゴリごとに最大 15,000 個のストレージ システム、シリアル番号ごとに最大 500 個のストレージ システムを追加できます。
...
. 「ウォッチリストを作成」を選択します。
. 監視リストの名前を指定します。
. ストレージ システムを監視リストに追加するには、次のいずれかのオプションを選択します。
+
