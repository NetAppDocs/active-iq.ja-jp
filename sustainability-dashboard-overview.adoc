...
---
= Digital Advisorのサステナビリティダッシュボード機能について学ぶ
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
*炭素排出削減率*：各サイト/都市における炭素排出削減率を表示します。表示される基準値は、お客様の所在地に基づいています。特定のサイトの炭素削減率を調整するには、パーセンテージ値の横にある image:edit_icon_1.png["編集可能なアイコンを示すスクリーンショット。"] アイコンを選択すると、炭素の数値が自動的に調整されます。
