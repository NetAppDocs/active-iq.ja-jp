...
| サポート更新 | すべてのプラットフォームでサポートされます | すべてのプラットフォームでサポートされます | すべてのプラットフォームでサポートされます 


| ストレージ拡張 | ONTAPでのみサポートされています | ONTAPでのみサポートされています | ONTAPでのみサポートされています 


| 在庫 | すべてのプラットフォームでサポートされます | ONTAPでのみサポートされています | ONTAPでのみサポートされています 


| アップグレード | ONTAPでのみサポートされています | ONTAPでのみサポートされています | ONTAPでのみサポートされています 
|===

NOTE: すべてのプラットフォームとは、ONTAP、Eシリーズ、StorageGRID、ONTAP Select、およびCloud Volumes ONTAPを指します。
