...
* * テクニカルケース * ：選択可能な期間にわたって、ケースタイプおよびオープンまたはクローズステータス別に、テクニカルケースの履歴を詳細に表示します。ケースグループにドリルダウンしたり、でケースの詳細を確認したりできます link:https://mysupport.netapp.com//["ネットアップサポートサイト"] またはその他のケースポータル。
