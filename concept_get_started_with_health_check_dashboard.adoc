...
* *AutoSupport導入状況*：AutoSupportが有効になっているシステムの数と割合を表示します。「拒否」とマークされたシステム、*HTTPS* と *AutoSupport on Demand* が有効になっているシステム、および過去7日間にAutoSupportデータの送信を停止したシステムの*信号喪失*も表示できます。インストールベースのシステムに関するヘルスチェックスコアと情報を表示するには、*AutoSupport導入状況*ウィジェットをクリックしてください。
